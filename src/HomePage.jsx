  ...
  {categoryGroups.map((group, groupIndex) => (
    <div
      ...
      style={{
        display: "flex",
        flexDirection: "column",
        alignItems: "center", // Center the group within the page
        marginBottom: "40px", // Space between groups
      }}
    >
      {/* Headline */}
      <h2
