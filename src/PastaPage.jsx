...
import pastaImage from './images/pastapic.jpg'; // Pasta Image
...
function PastaPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/recipes?category=pasta') // Adjust the endpoint as needed
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <h1 style={styles.heroText}>Pasta Recipes</h1>
      </div>

      {/* Content Section */}
      <div style={styles.contentSection}>
        <h2 style={styles.headline}>Savor the Taste of Italy!</h2>
        <p style={styles.description}>
          Indulge in a variety of pasta recipes, from creamy sauces to zesty classics.
          Discover your favorite way to enjoy this beloved Italian dish!
        </p>
