...
import riceImage from './images/rice.jpg'; // Rice Image
...
function RicePage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/recipes?category=rice') // Adjust the endpoint as needed
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <h1 style={styles.heroText}>Rice Recipes</h1>
      </div>

      {/* Content Section */}
      <div style={styles.contentSection}>
        <h2 style={styles.headline}>Elevate Your Meal!</h2>
        <p style={styles.description}>
          Explore a world of rice recipes, from fragrant plov to hearty risottos.
          Find the perfect side or main dish to satisfy your cravings!
        </p>
