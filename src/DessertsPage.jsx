...
import dessertsImage from './images/chocolatecubes.jpg'; // Desserts Image
...
const styles = {
  ...
  heroSection: {
    ...
    height: '30vh',
    width: '100%',
    backgroundImage: `url(${dessertsImage})`,
...
function DessertsPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/recipes?category=desserts') // Adjust the endpoint as needed
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <h1 style={styles.heroText}>Desserts Recipes</h1>
      </div>

      {/* Content Section */}
      <div style={styles.contentSection}>
        <h2 style={styles.headline}>Indulge in Sweet Delights!</h2>
        <p style={styles.description}>
          Discover a delightful array of desserts, from decadent cakes to creamy puddings.
          Perfect your end-of-meal treat with these irresistible recipes!
        </p>
