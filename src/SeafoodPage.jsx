...
import seafoodImage from './images/seafood.jpg'; // Seafood Image
...
const styles = {
  ...
  heroSection: {
    ...
    height: '30vh',
    width: '100%',
    backgroundImage: `url(${seafoodImage})`,
...
function SeafoodPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/recipes?category=seafood') // Adjust the endpoint as needed
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <h1 style={styles.heroText}>Seafood Recipes</h1>
      </div>

      {/* Content Section */}
      <div style={styles.contentSection}>
        <h2 style={styles.headline}>Taste the Ocean!</h2>
        <p style={styles.description}>
          Dive into a collection of fresh and flavorful seafood recipes.
          From light dishes to hearty seafood feasts, enjoy the best of the sea!
        </p>
