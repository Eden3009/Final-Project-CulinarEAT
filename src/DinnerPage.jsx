...
import dinnerImage from './images/dinner.jpg'; // Dinner Image
...
function DinnerPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/recipes?category=dinner') // Adjust the endpoint as needed
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.heroSection}>
        <h1 style={styles.heroText}>Dinner Recipes</h1>
      </div>

      {/* Content Section */}
      <div style={styles.contentSection}>
        <h2 style={styles.headline}>End Your Day Deliciously!</h2>
        <p style={styles.description}>
          Explore our collection of satisfying dinner recipes, perfect for every evening.
          From light meals to indulgent feasts, find your next favorite dinner idea!
        </p>
